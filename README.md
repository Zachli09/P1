...
int main() {
    ...
    // Always print money with 2 decimal places
...
void makeChange() {
    ...
    if (paid < owed) {
        ...
        cout << "Needs to provide more money."
             << endl;
    }

    else if (paid == owed) {

        cout << "Don't need change."
             << endl;
    }
...
double giveRefund(double runningTotal) {
    ...
    if (runningTotal - refundAmount < 0) {
        ...
        cout << "Refund didn't go through."
             << endl;

        cout << "Speak to the manager."
             << endl;
    }
